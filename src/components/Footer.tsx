...
const Footer = () => (
  <footer className="border-t-4 border-arcade-pink py-12 px-4 bg-[#050505] relative overflow-hidden">
    ...
    <div className="container mx-auto max-w-6xl relative z-10">
      <div className="grid md:grid-cols-3 gap-10 items-center">
        ...
        <div className="flex flex-col items-center md:items-start gap-4">
          <img src={logo} alt="ADSOPHOS 2026" className="h-16 w-auto drop-shadow-[0_0_15px_rgba(236,72,153,0.3)] transition-transform hover:scale-105" />
        ...
        {/* Links */}
        <div className="grid grid-cols-2 gap-y-4 gap-x-2 text-center md:text-left mx-auto">
